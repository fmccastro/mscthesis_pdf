...
% 'makeroom' package
% Add option to strikethrough equation on math mode
...
%	'ifthen package
%	>provides a way to build tikz picture with conditional statements
\usepackage{ifthen}
...
%	'mathtools' package
%	It was added to support text above arrows
...
%	Dashed lines on matrix block
\usepackage{arydshln}

\usepackage{tikz}
\usetikzlibrary {3d, perspective, datavisualization, calc, patterns}
...
%
%	It allows for footnotes on figure captions.
\usepackage{tablefootnote}

% 'enumitem' package
%
% Type customized bullets within itemize or
% enumerate lists.
% https://ctan.org/pkg/enumitem
%
% > This package provides user control over the layout of the three basic list environments: 
% enumerate, itemize and description. It supersedes both enumerate and mdwlist 
% (providing well-structured replacements for all their funtionality), and in addition
% provides functions to compute the layout of labels, and to ‘clone’ the standard environments,
% to create new environments with counters of their own. 
\usepackage{enumitem}
\usepackage{amssymb}
...
\usepackage{pgf, pgfplots, pgfplotstable, pgffor, pgfmath}
...
\newcommand{\WheelFrame}{\mathcal{C}}
\newcommand{\Robot}{\mathcal{R}}
\newcommand{\RobotCircleHullArea}{\mathcal{H}}
\newcommand{\RobotHullArea}{\mathcal{H}}
\newcommand{\Area}{\mathcal{A}}

% Domains
\newcommand{\SafeSpace}{\mathcal{S}}
\newcommand{\FreeSpace}{\mathcal{F}}
\newcommand{\ObstacleSpace}{\mathcal{O}}
\newcommand{\StateSpace}{\mathcal{X}}
\newcommand{\ControlSpace}{\mathcal{U}}
\newcommand{\feasibleSet}{\bm{\Omega}}
\newcommand{\neighborhood}{\mathcal{V}}
\newcommand{\activeSet}{\mathcal{A}}

%	Matrices
\newcommand{\RotMatrix}{R}
\newcommand{\InertiaTensor}{I}
\newcommand{\SkewSymmetricMatrix}{S}
\newcommand{\ConstraintJacobianMatrix}{A}
\newcommand{\IdentityMatrix}{I}

%%%	Variables	%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\wheelPosition}{r}
\newcommand{\positionVector}{d}
\newcommand{\wheelAngPosition}{q}
\newcommand{\wheelToContact}{w}
\newcommand{\contactPoint}{c}
\newcommand{\gravity}{g}

%	Position
\newcommand{\Position}{p}
...
%	General reference
\newcommand{\reference}{\mathbf{r}}

%	Linear velocity
\newcommand{\LinVelocity}{v}
...
\newcommand{\NormalForce}{n}

%	Friction force subscript
\newcommand{\FrictionSubscript}{f}

%	Normal force susbcript
\newcommand{\NormalForceSubscript}{n}

%	General force
\newcommand{\ForceSubscript}[1]{f_{#1}}
\newcommand{\ForceSubscriptTwo}[2]{f_{#1, #2}}
...
%	Linear Moment
\newcommand{\linearMoment}{l}

%	Angular moment
\newcommand{\angularMoment}{h}

\newcommand{\SpatialVelocity}{s}

\newcommand{\LinAccel}{a}
\newcommand{\AngAccel}{\alpha}
\newcommand{\SpatialAccel}{c}

\newcommand{\Torque}{\tau}

\newcommand{\Progress}{\rho}
\newcommand{\SlipRatio}{s}
\newcommand{\SlipAngle}{\beta}
\newcommand{\Mass}{m}
\newcommand{\WheelRadius}{r}
\newcommand{\WheelLonSeparation}{b}
\newcommand{\WheelLatSeparation}{l}
\newcommand{\Barrier}{\gamma}
\newcommand{\FrictionCoefficient}{\mu}
\newcommand{\surfaceRelVel}{\delta}
\newcommand{\NullTimePosition}{\Gamma}
\newcommand{\hmultiplier}{\mu}
\newcommand{\gmultiplier}{\lambda}
\newcommand{\SamplingTime}{T_s}

%	Elevation
\newcommand{\Elevation}{h}
\newcommand{\FunctionElevation}{h}
\newcommand{\ElevationMap}{\mathcal{E}}

%	Traversability cost
\newcommand{\TraversabilityCost}{c}
\newcommand{\FunctionTraversability}{t}
\newcommand{\TraversabilityMap}{\mathcal{T}}

%	Two layer map
\newcommand{\TwoLayerMap}{\mathcal{M}_2}
\newcommand{\TwoLayerMapArg}[1]{\mathcal{M}_{2,#1}}
\newcommand{\DiscTwoLayerMap}{\mathcal{M}'_2}
\newcommand{\DiscTwoLayerMapArg}[1]{\mathcal{M}'_{2,#1}}
\newcommand{\FunctionTwoLayerMap}{m_2}

%%%	Map grid dimensions	%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\MapDimx}{l_x}
\newcommand{\MapDimy}{l_y}
\newcommand{\GridDimX}{n_x}
\newcommand{\GridDimY}{n_y}

%%%	Functions	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\speedFunction}[1]{F(#1)}
\newcommand{\timeFunction}[1]{u(#1)}
\newcommand{\lagrangeTerm}[1]{l(#1)}
\newcommand{\mayerTerm}[1]{m(#1)}
\newcommand{\processModel}[1]{\mathbf{f}(#1)}
\newcommand{\eqCon}[1]{\mathbf{g}(#1)}
\newcommand{\ineqCon}[1]{\mathbf{h}(#1)}
\newcommand{\lagrangian}[1]{\mathcal{L}(#1)}

%%%	Domain	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\domain}[1]{D_{#1}}

%%%	Derivatives	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\DerMathBold}[1]{\mathbf{\dot{#1}}}
\newcommand{\DerBold}[1]{\bm{\dot{#1}}}
...
\newcommand{\shpw}{SHPW}
\newcommand{\mhpw}{MHPW}
\newcommand{\shpwgap}{SHPW }
\newcommand{\mhpwgap}{MHPW }

%%%	Call equation	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand{\refeq}[1]{equation \eqref{#1}}
...
\definecolor{tabvs}{RGB}{30,145,30}