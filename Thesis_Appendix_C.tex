...
\chapter{Additional traversability maps and performance results of controllers}
\label{chapter:annexData}

\section{Traversability maps}
\label{section:traversabilityMaps}

This section presents the traversability maps computed for the \mhpwgap variant with respect to the provided parameters.

\begin{figure}[H]
    \centering
	\begin{subfigmatrix}{4}
	\subfigure[Algorithm \nameref{alg:slopeMinHeightMapVarYaw}] {
    	\includegraphics[width=0.40\linewidth]{Figures/HeightMin_maxInclination+Surface+1.png}  
	}
	\subfigure[Algorithm \nameref{alg:maxRoughnessMap}] {
    	\includegraphics[width=0.40\linewidth]{Figures/maxTerrainRoughness+1.png}  
	}
	\subfigure[Worst-case map] {
    	\includegraphics[width=0.40\linewidth]{Figures/worstCase+Surface+1.png}  
	}
	\subfigure[Algorithm \nameref{alg:refinedMap}, where $r_s$ = 0.2 m and $C$ = 0.9] {
    	\includegraphics[width=0.40\linewidth]{Figures/mapRefinement+Surface+0.9+0.2+1.png}  
	}
	\end{subfigmatrix}
    \caption{Traversability maps (\acrshort{mhpw})}
...
\subsection{Planar \acrshort{nmpc}}
...
\begin{table}[!htb]
  \caption[Performance of controllers when control horizon changes.]{Performance of controllers when control horizon changes.}
  ...
  \begin{tabular}{lccccc}
    ...
    \midrule
    \ti{Cumulative control effort $[N \cdot s]$} & & & & &\\
    \shpw & $44.11$ & $46.14$ & $47.32$ & $44.82$ & $45.50$ \\
    \mhpw & $50.64$ & $51.03$ & $52.09$ & $55.88$ & $55.00$ \\
    \midrule
    \ti{Cumulative positional error $[m]$} & & & & &\\
    \shpw & $366.14$ & $306.58$ & $279.74$ & $255.94$ & $246.12$ \\
    \mhpw & $410.20$ & $369.43$ & $353.80$ & $384.91$ & $380.31$ \\
    \midrule
    \ti{Cumulative heading error $[rad]$} & & & & &\\
    \shpw & $64.91$ & $77.72$ & $84.80$ & $92.25$ & $193.79$ \\
    \mhpw & $60.11$ & $70.18$ & $76.27$ & $174.84$ & $177.28$ \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!htb]
  ...
  \begin{tabular}{lccccc}
    ...
    \midrule
    \ti{Cumulative control effort $[N]$} & & & & &\\
    \shpw & $36850.52$ & $5843.68$ & $4732.39$ & $3838.71$ & $3549.30$ \\
    \mhpw & $29865.59$ & $6865.72$ & $5209.71$ & $4655.98$ & $3887.58$ \\
    \midrule
    \ti{Cumulative positional error $[m]$} & & & & &\\
    \shpw & $3249.56$ & $651.12$ & $279.74$ & $126.99$ & $25.76$ \\
    \mhpw & $3209.73$ & $707.17$ & $353.79$ & $233.30$ & $253.01$ \\
    \midrule
    \ti{Cumulative heading error $[rad]$} & & & & &\\
    \shpw & $416.87$ & $144.87$ & $84.80$ & $47.46$ & $20.41$ \\
    \mhpw & $407.51$ & $131.96$ & $76.27$ & $89.37$ & $38.27$ \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lccccc}
    \toprule
     & Pose tracker & \shortstack{Position\\tracker} & \shortstack{Heading\\tracker} & \shortstack{Low control\\effort} & Smooth control \\
    \midrule
    \ti{\shortstack{Cumulative control\\effort $[N \cdot s]$}} & & & & &\\
    \shpw & $44.82$ & $42.10$ & $45.35$ & $23.75$ & $41.48$ \\
    \mhpw & $55.88$ & $55.55$ & $55.49$ & $45.67$ & $51.80$ \\
    \midrule
    \ti{\shortstack{Cumulative positional\\error $[m]$}} & & & & &\\
    \shpw & $255.94$ & $224.08$ & $309.85$ & $304.24$ & $261.74$ \\
    \mhpw & $384.91$ & $387.25$ & $390.92$ & $510.10$ & $391.27$ \\
    \midrule
    \ti{\shortstack{Cumulative heading\\error $[rad]$}} & & & & &\\
    \shpw & $92.25$ & $117.63$ & $70.44$ & $108.00$ & $90.72$ \\
    \mhpw & $174.84$ & $186.69$ & $162.88$ & $192.66$ & $174.55$ \\
    \bottomrule
  \end{tabular}
\end{table}
...
%  \begin{tabular}{lccccc}
%    \toprule
%     & Pose tracker & Position tracker & Heading tracker & Low control effort & Smooth control \\
%    \midrule
%    \shpw & $255.94$ & $224.08$ & $309.85$ & $304.24$ & $261.74$ \\
%    \mhpw & $384.91$ & $387.25$ & $390.92$ & $510.10$ & $391.27$ \\
%    \bottomrule
...
\subsection{Reference tour with a real-time \acrshort{nmpc} over uneven, rigid terrain}
\label{subsection:realtimeonestageocpRoughUnevenTerrain}

The results of the reference tour are presented below. Solver \ti{Low rate of change} is applied and has proven to be computionally feasible and to deliver low cost feedbacks. The reference heading is followed and slippage only arises at the highest inclinations. The traction rates only reach unusual values where there is a need to correct for a $\pi\,[rad]$ deviation of the mobile robot in the beginning. After this initial correction, the solver completely focuses on balancing the mobile robot and tracking the reference. Among $100000$ simulation iterations, the solver only fails on $0.014\,\%$ of the iterations and slippage only happens on $0.026\,\%$ of the iterations. $4$ timeouts were recorded. 

Along the reference tour, the recorded loop time and optimal cost are $(7.4) \pm (2.0)\,[ms]$ and $(0.26) \pm (5.26)$, respectively.

\begin{figure}[!htb]
  \begin{subfigmatrix}{4}
    \subfigure[Loop time along reference. The black circles denote the places where slippage takes place.]{\includegraphics[width=0.49\linewidth]{Figures/Real time one stage OCP on rough terrain/Rough and uneven terrain map/reference_tour_opt_time.pdf}}
    \subfigure[Optimal cost along reference.]{\includegraphics[width=0.49\linewidth]{Figures/Real time one stage OCP on rough terrain/Rough and uneven terrain map/reference_tour_opt_cost.pdf}}
    \subfigure[Traction forces on friction cone. White window denotes the iterations where slippage or solver fail was recorded.]{\includegraphics[width=0.49\linewidth]{Figures/Real time one stage OCP on rough terrain/Rough and uneven terrain map/reference_tour_forces_cone.png}}
    \subfigure[Traction rates along simulation.]{\includegraphics[width=0.49\linewidth]{Figures/Real time one stage OCP on rough terrain/Rough and uneven terrain map/reference_tour_forces_rate_curve.png}}
  \end{subfigmatrix}
  \caption{Results of reference tour.}
