...
\begin{figure}[!ht]
	...
	\subfigure[Algorithm \nameref{alg:slopeMinHeightMapVarYaw}] {
    	\includegraphics[width=0.48\linewidth]{Figures/HeightMin_maxInclination+Surface+1.png}  
	}
...
\begin{figure}[!ht]
	...
	\end{subfigmatrix}
    \caption{Traversability maps (\mhpw)}
...
\begin{figure}[!htb]
  \begin{subfigmatrix}{4}
    \subfigure[Loop time along reference.]{\includegraphics[width=0.49\linewidth]{Figures/Real time one stage OCP on rough terrain/Rough and uneven terrain map/reference_tour_opt_time.pdf}}
    ...
    \subfigure[Traction forces on friction cone.]{\includegraphics[width=0.49\linewidth]{Figures/Real time one stage OCP on rough terrain/Rough and uneven terrain map/reference_tour_forces_cone.png}}
